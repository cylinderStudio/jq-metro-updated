...
(function ($, window, document, undefined) {
    ...
    jQuery.widget("mobile.scrollview", jQuery.mobile.widget, {
        options: {
            ...
            propagateEvent: false //M Valipour
        },
        ...
        _create: function () {
            ...
            //if (this.options.direction.length > 0) overflowKey += "-" + this.options.direction;

            this._$clip.css(overflowKey, this.options.scrollMethod === "scroll" ? "scroll" : "hidden");
            this._makePositioned(this._$clip);

            this._$view.css(overflowKey, "hidden");
        ...
        _handleDragStart: function (e, ex, ey) {
            ...
            if (!this.options.propagateEvent) { // M Valipour
